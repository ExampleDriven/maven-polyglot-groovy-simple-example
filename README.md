[![Build Status](https://travis-ci.org/ExampleDriven/maven-polyglot-groovy-simple-example.svg?branch=master)](https://travis-ci.org/ExampleDriven/maven-polyglot-groovy-simple-example)
